...
<div class="hasflex" id='main'>
	...
	if(isset($_POST['submit'])){
		...
		if(!isset($error)){
			...
			try {
				...
				$stmt = $db->prepare('UPDATE blog_posts_seo SET postImage = :postImage, postTitle = :postTitle, postSlug = :postSlug, postDesc = :postDesc, postCont = :postCont WHERE postID = :postID') ;
				$stmt->execute(array(
                    ':postImage' => $imageFile,
					':postTitle' => $postTitle,
					':postSlug' => $postSlug,
	...
	if(isset($error)){
		...
		try {
			...
			$stmt = $db->prepare('SELECT postThumb, postImage, postID, postTitle, postDesc, postCont FROM blog_posts_seo WHERE postID = :postID') ;
